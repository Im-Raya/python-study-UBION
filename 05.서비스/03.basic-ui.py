...
#슬라이더
Values = st.slider("범위의 값을 다음과 같이 지정", 0.0,100.0,(25.0, 75.0))
...
# 텍스트 입력 
title = st.text_input(
    label= "가고 싶은 여행지가 있나요?", placeholder="여행지를 입력해 주세요"
...
number = st.number_input(
    label="나이를 입력해 주세요.", min_value=10, max_value=100, value=30, step=5
)
